...
export const CoverLetterPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-bold font-outfit text-slate-900">Job-Specific Cover Letter</h1>
      ...
      {/* Main Cover Letter Document Card */}
      <Card className="p-8 bg-white border-slate-300 shadow-xl max-w-3xl mx-auto space-y-6">
        <div className="border-b border-slate-200 pb-4">
          <div className="flex justify-between items-start">
            ...
            <Badge variant="brand" size="sm">AG-005 Linked</Badge>
          </div>
        </div>
        ...
        <textarea
          ...
          rows={14}
          className="w-full p-4 rounded-xl border border-slate-200 text-xs leading-relaxed font-sans text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-500"
        />

        <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-xs">
          <span className="text-slate-400">Linked to Tailored ATS Resume Version</span>
          <Button
            variant="ghost"
            size="sm"
